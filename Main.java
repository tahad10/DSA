...
INSERT INTO todos (id, title, description) VALUES (1, 'Dekorieren', 'Es ist nun endlich so weit! Mit dem 01. November wird es Zeit, zügig die Weihnachtsdekorationen auszupacken.'), (2, 'New todo', '(NULL)'), (3, 'Weitere Todos für die TodoAPI! eintragen', '(NULL)'), (4, 'Backen', 'Bald sollte ich Weihnachtsplaetzchen backen.'), (13, 'Die Attribute eines Todo-Objekts für die TodoAPI definieren', '(NULL)'), (42, 'Die Geschaeftslogik fuer die TodoAPI entwerfen', ' ');
